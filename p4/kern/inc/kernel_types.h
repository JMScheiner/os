...
struct THREAD_CONTROL_BLOCK{
   ...
   /** @brief Thread id. Unique accross all threads, living and dead. */
   int tid;

   /** @brief Process control block of this thread. */
   pcb_t *pcb;

   /** @brief Saved kernel stack pointer for this thread, for context
    * switching. */
   void *esp;
   ...
   /** @brief Bottom of the kernel stack, for mode switching. */
   void *kstack;
...
/** @brief Binary heap of sleeping threads. */
struct SLEEP_HEAP 
{
...
/** @brief Link in a hashtable storing a tid -> tcb mapping. */
...
/** @brief Hash table mapping tids to tcbs. */
struct HASHTABLE
{
