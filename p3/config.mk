...
# directory.
#
STUDENTTESTS = gettid_test exec_test1 exec_test2 tfork_test
...
KERNEL_OBJS += handlers/exec_handler.o handlers/fork_handler.o scheduler.o
KERNEL_OBJS += handlers/pop_stub.o
